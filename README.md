...
$ curl -GET http://127.0.0.1:9292/api/v2/info/MA02004.json
...
$ curl -GET http://127.0.0.1:9292/api/v2/courselist
...
$ curl -H "Content-Type: application/json" -X POST -d '{"keyword":"program"}' http://127.0.0.1:9292/api/v2/search
